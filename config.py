...
HS_GYRO_SENSOR: str     = "Foot"      # Gyro 소스 센서 (MLS가 RMSE 18ms로 최적)
...
HS_ACCEL_PEAK_SIGMA: float = 1.8
HS_GYRO_VALID_SIGMA: float = 0.5       # Trusted swing threshold (mid-swing max의 20%)
